...
const VIDEOS = [
  {
    ...
    quote:
      "Přemýšlel jsem o změně oboru, i kvůli AI. Elektriku snad nahradit nemůže. Znalosti jsem si konečně ucelil v kuse; po malých kouscích z internetu to není ono. S přístupem pana lektora zkouška nebyla těžká.",
